...
class Example extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      prevmotto: window.cs142models.exampleModel().motto,
      counter: 0,
      inputValue: '',
      buttonWasClicked: '',
    };
  ...
  handleMottoSubmit(event) {
    alert('Submit motto: ' + this.state.motto);
    this.setState({prevmotto: this.state.motto});
    ...
    return (
      <div className="container Example">
        ...
        <div className="motto-update">
          ...
          <p>My motto is {this.state.prevmotto}</p>
